...
plugin_identifier = "debug_enabled"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_debug_enabled"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "OctoPrint-DebugEnabled"
...
# module
plugin_description = """Simple Test to Check if debug logging is enabled."""
...
plugin_url = "https://github.com/jneilliii/OctoPrint-DebugEnabled"
